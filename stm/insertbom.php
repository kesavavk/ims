...
if(($tax2>0 && $tax1>0) || ($disc1>0 && $disc2>0)){
	...
	$query = "insert into bom(prid,locref,cat,uom,qty,mrp,tax,discount,matstatus,matcode,matsdesc,matldesc,pono,vendor)
	values('$prid','$locref','$cat','$uom','$qty','$mrp','$tax','$disc','$matstatus','$matcode','$matsdesc','$matldesc','$pono','$vendor')";
	$af = mysql_query($query);
