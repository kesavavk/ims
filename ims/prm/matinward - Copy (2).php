...
<form method="post" name="form1" action=" " enctype="multipart/form-data">	
					...
					<table border="0">
						...
						<tr><td>Project ID<input type="text" name="prid" onkeyup="up(this)"><input type="button" name="button3" value="GET" onClick="getinfo()"></td>
						<td>Project Name
							<input type="text" name="prname" onkeyup="up(this)" value='<?php echo $prname; ?>'>
								</td>
					...
					<tr>
							...
							<input type="text" name="locref" onkeyup="up(this)" value='<?php echo $locref; ?>'>
								</td></tr>
								<tr>
								<td>Cat/Part No Reference
							<input type="text" name="cat" onkeyup="up(this)" value='<?php echo $cat; ?>'>
								</td>
								</tr>
								
								<tr><td>
<textarea rows="4" cols="30" name="prsdesc"  value='<?php echo $prsdesc; ?>'></textarea></td></tr><tr>
<td>
<textarea rows="4" cols="30" name="prldesc"  value='<?php echo $prldesc; ?>'></textarea></td>
	
	</tr>						
	<tr><td>
	Quantity<input type="text" name="qty" onkeyup="up(this)" value='<?php echo $qty; ?>'></td></tr>
	
	
	<tr><td>UoM<input type="text" name="uom" onkeyup="up(this)" value='<?php echo $uom; ?>'></td>
