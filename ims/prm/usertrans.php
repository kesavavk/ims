...
<div id="font15">
	...
	From: Date: &nbsp;<select name="select3">
										...
										<select name="select1">
											  ...
											  <table border="0"><tr>
											 <td align="center" width="400" >  To : Date :&nbsp; &nbsp;&nbsp;
											  <select name="select4">
												  <option value="1">1</option><option value="2">2</option>
												  <option value="3">3</option><option value="4">4</option>
												  <option value="5">5</option><option value="6">6</option>
										...
										<select name="select5">
											  ...
											  <option value="2030">2030</option><option value="2031">2031</option>
											  	...
											  	<table><tr><td>
													...
													<input type="submit" value="Show" name="button"></td>
													</tr></table>
											  		<?php
...
//echo $uname;
							...
							//echo"</table> ";
							echo "<table border='1' width='150%'><tr><td>S.No</td><td>Project Code</td><td>Username</td><td>Date</td><td>Status</td><td>Remarks</td></tr>";
						$sno = 0;
						if($uname==' '){
						$bomqry = mysql_query("select * from usertrans");
					}
					else { 
						$bomqry = mysql_query("select * from usertrans where  date between '$date1' and '$date2' and uname='$uname'"); }
						while($getbomqry = mysql_fetch_array($bomqry)){
							...
							echo "<tr><td>".$sno."</td><td>".$prid."</td><td>".$user."</td><td>".$date."</td><td>".$status."</td><td>".$remark."</td></tr>";
