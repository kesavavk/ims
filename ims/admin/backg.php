...
<body>
				 ...
				 <div id="menu">
								...
								<div>
		          <h1><font color="black" size="5px"><center>e-Project Management</center></font></h1>
						
					  <ul id="nav">
							
						  <li id="active"><a href="Projectsfrm.php">Projects</a></li>
					   <li id="active"><a href="bomlistfrm.php">BOM List</a></li>
					    <li id="active"><a href="goodreceiptfrm.php">Goods Receipt</a></li>
					     <li id="active"><a href="goodissuefrm.php">Goods Issue</a></li>
					      <li id="active"><a href="stockfrm.php">Stock</a></li>
					<li id="active"><a href="userfrm.php">Admin</a></li>
