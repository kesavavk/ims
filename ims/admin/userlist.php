...
<?php
							...
							//echo"</table> ";
							echo "<table border='1' width='150%'><tr><td>S.No</td><td>Full Name</td><td>User Type</td><td>Username</td><td>Password</td><td>Delete</td></tr>";
						$sno = 0;
						...
						while($getbomqry = mysql_fetch_array($bomqry)){
							...
							echo "<tr><td>".$sno."</td><td>".$fname."</td><td>".$utype."</td><td>".$user."</td><td>".$pwd."</td>
							<td><a href='deletecust.php?action=2&uname=".$user."' onClick='return confirmdel()'>
							Delete</a></td></tr>";
