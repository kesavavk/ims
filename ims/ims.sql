...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2016 at 04:12 PM
...
INSERT INTO `admin` (`uid`, `uname`, `upassword`, `utype`) VALUES
(1002, 'admin', 'admin', 1);
...
(2, 'x', 'M1', 'asdfas', 5, '2004-01-01', 'asdfas', 'asdfas', '0000-00-00', '', 'M1', 'NO', 'asdfas', ''),
(3, 'mat01', 'GKPR', 'asdf', 0, '2004-01-01', 'asdfas', 'awsefa', '0000-00-00', '', 'M1', 'NO', 'asdfas', ''),
(4, 'mat01', 'GKPR', 'asdf', 3, '2004-01-01', 'asdf', 'asdf', '0000-00-00', 'asdfs', 'M1', 'NO', 'asd', ''),
(5, 'mat01', 'GKPR', 'asdfsad', 2, '2004-01-01', 'asdfsadf', 'asdfasd', '0000-00-00', 'asdfasdf', 'M1', 'NO', 'asdfsad', ''),
(7, 'mat01', 'GKPR', 'IStx', 3, '2004-01-01', '', 'xx', '0000-00-00', 'po1', 'M1', 'NO', '', '');
...
(6, '', '', '2004-01-01', '', '', 'mat01', '', 10, 0, '', 'GKPR', '', '', 1, '', ''),
...
INSERT INTO `user` (`uname`, `fname`, `utype`, `pwd`, `datec`) VALUES
('admin', 'admin', 1, '1234', '2016-06-08'),
('pmuser', 'pmuserkesava', 2, 'pmuser', '2016-06-08'),
('smuser', 'smuser', 0, 'smuser', '2016-06-08');
...
INSERT INTO `usertrans` (`trid`, `prid`, `uname`, `status`, `remark`, `date`) VALUES
(4, 'GKPR', 'admin', 'lasdfj', 'asldkfj', '2016-06-08'),
(5, 'GKPR', 'pmuser', 'i am pm user i can only create and view projects and bill of materials', 'ssss', '2016-06-08'),
(6, 'GKPR', 'smuser', 'i am smuser', 'ass', '2016-06-08'),
(7, 'GKPR', 'smuser', 'hi this is sm user', '', '2016-06-08'),
(8, 'GKPR', 'pmuser', 'hi iam pmuser', '', '2016-06-08'),
(9, 'GKPR', 'pmuser', 'asdefasdf', 'ASDFASD', '2016-06-08');
...
--
ALTER TABLE `bom`
  MODIFY `bid` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `issuedgoods`
--
ALTER TABLE `issuedgoods`
  MODIFY `gino` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
