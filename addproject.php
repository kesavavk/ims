...
<textarea rows="3" cols="40" name="prsdesc" placeholder="Project Short Description"></textarea></td><td>Long Description</td>
<td>
<textarea rows="3" cols="40" name="prldesc" placeholder="Project Long Description"></textarea></td>
