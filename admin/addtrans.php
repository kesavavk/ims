...
<?php if(isset($_GET["unm"])==1){
							echo"<center><font color='red'>username should not be empty or Enter valid username</font></center>";
							}?></td>				
	</tr>		
...
<tr><td>Status</td><td><textarea rows="3" cols="30" name="status"></textarea>
<?php if(isset($_GET["status"])==1){
							echo"<center><font color='red'>Status should not be empty</font></center>";
							}?></td></tr><tr>
